 ...
 * @author vanes
 */
public class ManualExperimentPisaMUITAS {
...
//            method.setFilenameFullDataset(filename+"_complete");
        method.execute(dir, filename, extension, null, SEPARATOR, valuesNulls, lstIgnoreColumns, patternDateIn, threshold_rc, threshold_rv);
